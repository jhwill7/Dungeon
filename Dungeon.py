...
for char in characters:
	print(char.name)
	print('{}\'s HP: '.format(char.name) + str(char.HP))
	print('{}\'s shield is the {} and it\'s effect is {}.'.format(char.name, char.shield.name, char.shield.ability))
	print('{}\'s armor is the {} and it\'s effect is {}.'.format(char.name, char.armor.name, char.armor.ability))
	print('{} also carries:'.format(char.name))
	for itm in char.possessions:
		print(itm.name)
		print("\t" + itm.ability)
	print()
	print()
...
for m in deck:
	print('The {} has {} strength, and can be beaten by {}.'.format(m.name, m.power, m.weakness))
